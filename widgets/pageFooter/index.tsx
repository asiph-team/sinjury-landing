...
import appStore from "../../public/assets/img/app_store.png"
import playStore from "../../public/assets/img/google_play.png"
import Image from 'next/image'

const PageFooter = () => {
  return (
<footer className="text-center bg-gray-900 text-white">
  <div className="w-100 px-6 pt-6">

  <div className="flex justify-center mb-6">
      <a href="#!" type="button" className="w-40 ">
       <Image
       src={appStore} />
      </a>
